...
class DataIngestionConfig:
    data_ingestion_dir: str = os.path.join(artifact_folder , "data_ingrstion")
...
class DataIngestion:
    ...
    def export_data_into_raw_data_dir(self):
        ...
        """
        try :
            logging.info(f"Explorting data from mongodb")
            ...
            logging.info(f"Saving export data into feature store file path : {raw_batch_file_path}")
            for collection_name , dataset in income_data.export_collections_as_dataframe():
                ...
                # dataset.rename(colunms = {"Unnamed :0":"Wafer}, inplace=True)
    ...
    def initiate_data_ingestion(self) -> Path :
        ...
        Description : This method inities the data ingestion components of training pipeline
        ...
        """
        logging.info("Entered initate_data_ingestion method of Data_Ingestion class")
